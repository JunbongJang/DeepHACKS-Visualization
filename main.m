% Created by Junbong Jang for HACKS visualization
% 6/15/2020 
...
hacks_type = 'HACKS'; % HACKS or DeepHACKS
...
deepHACKS_cmap = [[0,0,0];[37,22,5]/255;[193,193,193]/255;[51,187,238]/255; [233,217,133]/255; [178,189,126]/255; [116,156,117]/255; [238,51,119]/255; [0,0,0]];
...
unique_cellnames = {'111017_PtK1_S01_1ml_CyD100_05';'111017_PtK1_S01_1ml_DMSO_07';'111017_PtK1_S01_1ml_DMSO_08-2';'111017_PtK1_S01_1ml_DMSO_08'};
% 
% g3-2 case
...
% unique_cellnames = {'111417_PtK1_S01_CyD100_03';'111417_PtK1_S01_CyD100_05';'111417_PtK1_S01_CyD100_07';'111417_PtK1_S01_CyD100_08'};
...
% unique_cellnames = {'111417_S02_CyD100_06';'111417_S02_CyD100_07';'111417_S02_CyD100_08';'111417_S02_CyD100_12'};
...
% unique_cellnames = {'111017_PtK1_S01_1ml_DMSO_05';'111017_PtK1_S01_1ml_DMSO_07';'111017_PtK1_S01_1ml_DMSO_08-2';'111017_PtK1_S01_1ml_DMSO_08'};
...
% unique_cellnames = {'111417_PtK1_S01_DMSO_03';'111417_PtK1_S01_DMSO_05';'111417_PtK1_S01_DMSO_07';'111417_PtK1_S01_DMSO_08'};
...
% unique_cellnames = {'111417_S02_DMSO_06';'111417_S02_DMSO_07';'111417_S02_DMSO_08';'111417_S02_DMSO_12'};
...
% unique_cellnames = {'Actin_dual_C5';'Actin_dual_C6';'Actin_dual_C7';'Actin_dual_C8';'Actin_dual_C11'};
...
% unique_cellnames = {'new_Arp23_C1';'new_Arp23_C3'};
...
% % unique_cellnames = {'120217_S02_CK689_50uM_06'; '120217_S02_CK689_50uM_09'; '120217_S02_CK689_50uM_07'; '120217_S02_CK689_50uM_08'; '120217_S02_CK689_50uM_13'};
% unique_cellnames = {'120217_S02_CK689_50uM_03';'120217_S02_CK689_50uM_07'; '120217_S02_CK689_50uM_08'; '120217_S02_CK689_50uM_13'};
...
% unique_cellnames = {'122217_S02_DMSO_01'; '122217_S02_DMSO_05';'122217_S02_DMSO_06';'122217_S02_DMSO_07';'122217_S02_DMSO_08';'122217_S02_DMSO_09';'122217_S02_DMSO_11'; ...
...
% all_cellnames = all_cellnames.Cellname_truncated %.case_dminpoolc; %.control_dminpoolc;
...
%%
make_all_movie_clusters(path_windowing, custom_table_hacks_cluster, custom_table_deephacks_cluster, all_cellnames, all_dminpool, unique_cellnames, ...
